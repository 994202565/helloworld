...
<UL>
  ...
  href="#">系统管理</A> 
    <DIV class=menu_childs onmouseout=Menus.Hide(0);>
  <UL>
    <LI><A href="include/admin/amend.jsp" target=frmright>修改密码</A> </LI>
    </UL></DIV>
  <DIV class=menu_div>
  <IMG style="VERTICAL-ALIGN: bottom"  src="images/menu01_right.gif"></DIV></LI>
  </UL>
</DIV></DIV></DIV>
<DIV style="BACKGROUND: #337abb;WIDTH:80%; HEIGHT: 24px"></DIV>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#c4d8ed 
        ...
        <TR height=32>
          ...
          background=images/bg2.gif>欢迎登陆：${sessionScope.admin.username}| <A 
            ...
            <A  href="AdminAction!logout.action"  onclick="return confirm('确定退出吗?')"  target=_top>退出 </A> </TD>
